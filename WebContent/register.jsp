			...
			<div class="login form">
				<div class="group">
					<div class="group-ipt email">
						<input type="text" name="student.xuehao" id="xuehao" class="ipt"
							placeholder="学号" required>
					</div>
					<div class="group-ipt password">
						<input type="password" name="student.password" id="password" class="ipt"
					...
					<div class="group-ipt user">
						<input type="text" name="name" id="student.name" class="ipt"
					...
					<div class="group-ipt user">
						<input type="text" name="class" id="student.class" class="ipt"
